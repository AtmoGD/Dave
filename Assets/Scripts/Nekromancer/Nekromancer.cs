...
public class Nekromancer : MonoBehaviour, IDamagable
{
    ...
    [field: SerializeField] public float DayTimeMultiplier { get; private set; }
    #endregion
    ...
    public void Init(PlayerController _playerController)
    {
        ...
        DayTimeMultiplier = stats.dayTimeMultiplier;
    ...
    public void AddDayTimeMultiplier(float _multiplier) { DayTimeMultiplier += _multiplier; }
    #endregion
